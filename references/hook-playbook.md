...
| `charcoal-noir` | `monochrome ink line art, thin clean strokes, heavy rain drawn as fine diagonal hatching, deep black shadows, no color` | 비·야경·비극. 실측 예: `examples/hyeonjingeon-lucky-day/` |
